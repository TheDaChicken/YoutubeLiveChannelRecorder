...
### SETUP SERVER
  ...
  run \_\_main\_\_.py in the server files folder with argument -p <port_name> to specify port.
...
### SETUP CLIENT
  ...
  run \_\_main\_\_.py in the client files folder. The client will then ask for ip and port.
